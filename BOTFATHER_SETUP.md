...
- При нажатии СТАРТ: фото + динамический текст:
  - Приветствие с именем
  - Статус подписки: ✅ Активный ключ или 📋 Нет ключей
  - Кнопка: 🔵 ПОЛУЧИТЬ КЛЮЧ или 🔄 ПРОДЛИТЬ СРОК
- Инструкции: выбор платформы IOS / ANDROID / WINDOWS / MACOS
