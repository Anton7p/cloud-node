...
export const rentServerKeyboard = () =>
  Markup.inlineKeyboard([
    [
      Markup.button.callback(NAVIGATION_LABELS.RENT_1M, NAVIGATION_ACTIONS.RENT_1M),
      Markup.button.callback(NAVIGATION_LABELS.RENT_3M, NAVIGATION_ACTIONS.RENT_3M),
    ],
    [Markup.button.callback(NAVIGATION_LABELS.RENT_12M, NAVIGATION_ACTIONS.RENT_12M)],
...
export const rentTermDetailsKeyboard = () =>
  Markup.inlineKeyboard([
    [Markup.button.callback(`${EMOJI.CARD} ${NAVIGATION_LABELS.PAY}`, NAVIGATION_ACTIONS.PAY_RENTAL)],
    [Markup.button.callback(`${EMOJI.BACK} ${NAVIGATION_LABELS.OTHER_TERM}`, NAVIGATION_ACTIONS.RENT_SERVER)],
